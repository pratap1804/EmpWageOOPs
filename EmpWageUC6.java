public class EmpWageUC6 {
	...
	if(res > 0.5) {
		...
		case 1:
			...
			totalFullTimeMonthlyWage1+=Wage_Per_Hour*Full_Day_Hours*Working_Days_Per_Month;
			Total_Hours++;
		...
		case 2:
			...
			while((Total_Hours < 101 && Working_Days_Per_Month <21)) {
				totalPartTimeMonthlyWage1+=Wage_Per_Hour*Part_Time_Hours*Working_Days_Per_Month;
				Total_Hours++;
				Working_Days_Per_Month++;
			} 
